...
typeDeclaration
    : classOrInterfaceModifier* (
         classDeclaration
//        | enumDeclaration // jak będzie czas
        | interfaceDeclaration
//        | annotationTypeDeclaration // nie wiem co to jest
//        | recordDeclaration // jak będzie czas
    )
    ;
...
classDeclaration
    : CLASS identifier (EXTENDS typeType)? (IMPLEMENTS typeList)?
    classBody
    ;
 ...
 */
methodDeclaration
    : classOrInterfaceModifier+ typeTypeOrVoid identifier methodParameters methodBody
    ; //kiedyś zamiast methodParameters było formalParameters, (THROWS qualifiedNameList)? zostało usunięte
...
constructorDeclaration
    : PUBLIC identifier methodParameters constructorBody = block
    ;
...
forControl
    : typeType variableDeclarator ';' expression ';' forUpdate = expression
    | ';;'
//    | enhancedForControl
    ;
